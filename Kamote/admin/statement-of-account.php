            ...
            <div class="glass-card tilt-hover p-6">
                <form method="GET" class="space-y-4">
                    ...
                    <div class="flex gap-2">
                        ...
                        <?php if ($employee_id): ?>
                            <a href="<?php echo base_url('admin/statement-print.php?employee_id=' . $employee_id . '&date_from=' . $date_from . '&date_to=' . $date_to); ?>" target="_blank" class="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition">
                                🖨️ Print Statement
                            </a>
                        <?php endif; ?>
                    </div>
                ...
                <div class="glass-card tilt-hover p-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
                        <div class="bg-blue-50 p-4 rounded-lg">
                            ...
                            <p class="text-2xl font-bold text-blue-700"><?php echo $summary['count']; ?></p>
                        </div>
                        <div class="bg-green-50 p-4 rounded-lg">
                            <p class="text-sm text-gray-600">Total Gross Pay</p>
                            <p class="text-2xl font-bold text-green-700"><?php echo formatCurrency($summary['total_gross']); ?></p>
                        </div>
                        <div class="bg-purple-50 p-4 rounded-lg">
                            <p class="text-sm text-gray-600">Total Net Pay</p>
                            <p class="text-2xl font-bold text-purple-700"><?php echo formatCurrency($summary['total_net']); ?></p>
                        </div>
                        <div class="bg-red-50 p-4 rounded-lg">
                            <p class="text-sm text-gray-600">Total Deductions</p>
                            <p class="text-2xl font-bold text-red-700"><?php echo formatCurrency($summary['total_deductions']); ?></p>
                        </div>
                    </div>
                        ...
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <tr class="bg-gray-100 font-bold">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo formatCurrency(array_sum(array_column($payrolls, 'base_salary'))); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo formatCurrency($summary['total_overtime']); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo formatCurrency($summary['total_allowances']); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo formatCurrency($summary['total_bonuses']); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-red-600"><?php echo formatCurrency($summary['total_deductions']); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900"><?php echo formatCurrency($summary['total_gross']); ?></td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-primary-700"><?php echo formatCurrency($summary['total_net']); ?></td>
