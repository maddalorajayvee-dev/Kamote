                                    ...
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm">
                                            <div class="flex justify-center gap-2">
                                                <a href="<?php echo base_url('admin/payroll-print.php?id=' . $payroll['id']); ?>" target="_blank" class="text-blue-600 hover:text-blue-800" title="Print">
                                                    
                                                </a>
                                                <a href="<?php echo base_url('admin/payroll.php?action=edit&id=' . $payroll['id']); ?>" class="text-primary-600 hover:text-primary-800" title="Edit">
