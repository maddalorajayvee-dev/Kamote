    ...
    <main class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="px-4 py-6 sm:px-0 space-y-6">
            <div class="glass-card tilt-hover p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <a href="<?php echo base_url('admin/employees.php?action=new'); ?>" class="px-6 py-3 bg-primary-600 text-white rounded-full hover:bg-primary-700 transition text-center">
                    + Add Employee
                </a>
            </div>
            ...
            <div class="glass-card tilt-hover p-4">
                <form method="GET" class="flex flex-col md:flex-row gap-2">
                    ...
                    <div class="flex gap-2">
                        <button type="submit" class="px-5 py-3 bg-gray-800 hover:bg-gray-900 text-white rounded-lg transition">
                            Search
                        </button>
                        <?php if ($search): ?>
                            ...
                            <li class="px-6 py-4 hover:bg-gray-50">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex space-x-2">
                                        <a href="<?php echo base_url('admin/statement-of-account.php?employee_id=' . $employee['id']); ?>" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                             Statement
                                        </a>
                                        <a href="<?php echo base_url('admin/employees.php?action=edit&id=' . $employee['id']); ?>" class="text-primary-600 hover:text-primary-800 text-sm font-medium">
                                            Edit
                                        </a>
