        ...
        <div class="px-4 py-6 sm:px-0 space-y-6">
            <div class="glass-card tilt-hover p-6 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                ...
                <div class="flex gap-2">
                    <a href="<?php echo base_url('admin/payroll-archive.php'); ?>" class="px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white rounded-full transition text-center">
                         View Archive
                    </a>
                            ...
                            <li class="px-6 py-4 hover:bg-gray-50">
                                <div class="flex items-center justify-between">
                                    ...
                                    <div class="flex space-x-2">
                                        <a href="<?php echo base_url('admin/payroll-print.php?id=' . $payroll['id']); ?>" target="_blank" class="text-blue-600 hover:text-blue-800 text-sm font-medium">
                                             Print
                                        </a>
                                        <a href="<?php echo base_url('admin/payroll.php?action=edit&id=' . $payroll['id']); ?>" class="text-primary-600 hover:text-primary-800 text-sm font-medium">
                                            Edit
                                        </a>
