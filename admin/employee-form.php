    ...
    <main class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div class="px-4 py-6 sm:px-0">
            <div class="mb-6 flex items-center justify-between">
                <a href="<?php echo base_url('admin/employees.php'); ?>" class="text-primary-600 hover:text-primary-800 text-sm font-medium mb-4 inline-flex items-center gap-2">
                    ← Back to Employees
                </a>
                ...
                <form method="POST" class="space-y-6">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" name="department" value="<?php echo htmlspecialchars($formData['department']); ?>" required
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent" />
                        </div>
