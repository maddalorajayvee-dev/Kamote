...
// Format dates
$start_date = date('F d', strtotime($period_start));
$end_date = date('d, Y', strtotime($period_end));
$period_display = $start_date . '-' . $end_date;
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Payroll - Barangay Sto. Angel</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        <div class="certification-section">
            <div class="cert-item">
                ...
                <div class="signature-box">
                    ...
                    <p><strong>Printed Name:</strong> <?php echo $chairman ? strtoupper($chairman['first_name'] . ' ' . ($chairman['middle_name'] ? substr($chairman['middle_name'], 0, 1) . '. ' : '') . $chairman['last_name']) : 'RICKY C. CAPISTRANO'; ?></p>
                    <p><strong>Position:</strong> Chairman, Com.on Appropriation</p>
            ...
            <div class="cert-item">
                ...
                <div class="signature-box">
                    <div class="signature-line"></div>
                    <p><strong>Printed Name:</strong> <?php echo $treasurer ? strtoupper($treasurer['first_name'] . ' ' . ($treasurer['middle_name'] ? substr($treasurer['middle_name'], 0, 1) . '. ' : '') . $treasurer['last_name']) : 'FROILAN M. AQUINO'; ?></p>
                    <p><strong>Position:</strong> Barangay Treasurer</p>
                    <p><strong>Date:</strong> _______________</p>
                </div>
            </div>
            ...
            <div class="cert-item">
                ...
                <div class="signature-box">
                    <div class="signature-line"></div>
                    <p><strong>Printed Name:</strong> <?php echo $punong_barangay ? strtoupper($punong_barangay['first_name'] . ' ' . ($punong_barangay['middle_name'] ? substr($punong_barangay['middle_name'], 0, 1) . '. ' : '') . $punong_barangay['last_name']) : 'JOVITO C. MAGHIRANG'; ?></p>
                    <p><strong>Position:</strong> Punong Barangay</p>
                    <p><strong>Date:</strong> _______________</p>
                </div>
            </div>
